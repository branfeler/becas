...
--
-- Servidor: localhost
-- Tiempo de generación: 11-09-2016 a las 22:08:17
...
ALTER TABLE `estudiante`
 ADD PRIMARY KEY (`id`), ADD KEY `id_datos` (`id_datos`,`id_vivienda`), ADD KEY `id_vivienda` (`id_vivienda`);
...
--
ALTER TABLE `materia`
ADD CONSTRAINT `fk_materia_estudiante` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id`);
